...
- **Topbar** (56px, white, bottom border `1px #ECEEF1`): search pill ("Search or start a request…" + ⌘K), freshness pill (`#E9F6EF` up-to-date / `#FBF3E0` stale, pulsing dot), Copilot button (`#EEF3FE` bg, `#2F6FED` text, border `#DCE6FB`), avatar "EH" + "Elira H." + role "MANAGER" (`#9A6B00`).
