...
FLOOR0 = [
    ...
    {"id": "SPACE-22", "name": "Space 22 — SW terrace", "floor": 0, "bearing": 215, "kind": "mid_ring_hall", "bookable": True, "level": 0.30, "area": 50, "ring": "outer", "note": "Wedge terrace / informal gathering & overflow."},
    {"id": "SPACE-23", "name": "Space 23 — West terrace", "floor": 0, "bearing": 250, "kind": "mid_ring_hall", "bookable": True, "level": 0.30, "area": 50, "ring": "outer", "note": "Wedge terrace near the West annex link; gathering / catering overflow."},
    {"id": "SPACE-29", "name": "Space 29 — NE terrace", "floor": 0, "bearing": 50, "kind": "mid_ring_hall", "bookable": True, "level": 0.50, "area": 45, "ring": "outer"},
    {"id": "SPACE-30", "name": "Space 30 — East terrace (stepped)", "floor": 0, "bearing": 90, "kind": "mid_ring_hall", "bookable": True, "levelRange": [0.18, 2.16], "stepped": True, "area": 80, "ring": "outer", "note": "Large east wedge with its own stairs, multi-level. Good for staged / standing receptions."},
    {"id": "SPACE-24", "name": "Space 24 — perimeter terrace", "floor": 0, "bearing": 150, "kind": "mid_ring_hall", "bookable": True, "level": 0.75, "area": 50, "ring": "outer", "idsToConfirm": True},
    {"id": "SPACE-25", "name": "Space 25 — perimeter terrace", "floor": 0, "bearing": 165, "kind": "mid_ring_hall", "bookable": True, "level": 0.75, "area": 50, "ring": "outer", "idsToConfirm": True},
    {"id": "SPACE-26", "name": "Space 26 — perimeter terrace", "floor": 0, "bearing": 320, "kind": "mid_ring_hall", "bookable": True, "level": 0.75, "area": 50, "ring": "outer", "idsToConfirm": True},
    {"id": "SPACE-27", "name": "Space 27 — perimeter terrace", "floor": 0, "bearing": 340, "kind": "mid_ring_hall", "bookable": True, "level": 0.75, "area": 50, "ring": "outer", "idsToConfirm": True},
    {"id": "SPACE-28", "name": "Space 28 — perimeter terrace", "floor": 0, "bearing": 20, "kind": "mid_ring_hall", "bookable": True, "level": 0.75, "area": 50, "ring": "outer", "idsToConfirm": True},
...
FLOORM1 = [
    {"id": "BOX-1.1", "name": "Central core 1.1", "floor": -1, "bearing": 0, "kind": "circulation_feature", "bookable": False, "level": -4.65, "ceiling": 2.90, "ring": "center", "note": "Lower segment of the central grand-stair hall."},
    {"id": "BOX-1.2", "name": "Central core 1.2", "floor": -1, "bearing": 120, "kind": "circulation_feature", "bookable": False, "level": -4.65, "ceiling": 3.00, "ring": "center", "note": "Central stair-hall segment; stairs up to Floor 0."},
    {"id": "BOX-1.3", "name": "Central core 1.3", "floor": -1, "bearing": 240, "kind": "circulation_feature", "bookable": False, "level": -4.65, "ceiling": 3.00, "ring": "center", "note": "Central stair-hall segment."},
    ...
    {"id": "M1-SPACE-17", "name": "Space 17 — central foyer/stairs", "floor": -1, "bearing": 180, "kind": "circulation", "bookable": False, "level": -4.65, "ring": "corridor", "note": "Foyer around the base of the central stairs."},
...
FLOOR3 = [
    ...
    {"id": "F3-BOX-16", "name": "Box 16", "floor": 3, "bearing": 0, "kind": "rim_room", "bookable": True, "level": 14.64, "ceiling": 2.70, "area": 45, "ring": "rimRooms", "note": "Enclosed room at the very top (north). Small VIP / lookout / meeting room."},
    {"id": "F3-SPACE-50", "name": "Space 50 — upper-rim room", "floor": 3, "bearing": 300, "kind": "rim_room", "bookable": True, "level": 13.20, "area": 40, "ring": "rimRooms", "idsToConfirm": True},
    {"id": "F3-SPACE-51", "name": "Space 51 — upper-rim room", "floor": 3, "bearing": 330, "kind": "rim_room", "bookable": True, "level": 13.20, "area": 40, "ring": "rimRooms", "idsToConfirm": True},
    {"id": "F3-SPACE-52", "name": "Space 52 — upper-rim room", "floor": 3, "bearing": 30, "kind": "rim_room", "bookable": True, "level": 13.20, "area": 40, "ring": "rimRooms", "idsToConfirm": True},
    {"id": "F3-SPACE-53", "name": "Space 53 — upper-rim room", "floor": 3, "bearing": 60, "kind": "rim_room", "bookable": True, "level": 13.20, "area": 40, "ring": "rimRooms", "idsToConfirm": True},
    {"id": "F3-SPACE-54", "name": "Space 54 — upper-rim room", "floor": 3, "bearing": 285, "kind": "rim_room", "bookable": True, "level": 13.20, "area": 40, "ring": "rimRooms", "idsToConfirm": True},
]
