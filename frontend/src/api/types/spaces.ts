...
export interface SpaceMap {
  ...
  // (see FLOOR_PLANS in floorplan.data.ts). Additive; radial fields stay for v1.
  polygon?: number[][]
  ...
  bookable?: boolean | 'conditional' // HARD filter: false = wc/technical/circulation (never a venue)
